        ...
        <form method="post" action="./api/edit.php?table=<?= e($do) ?>">
            ...
            <table width="100%">
                <tbody>
                    ...
                    $rows=$db->all([], ['limit'=>$div, 'offset'=>$start]);
                     foreach($rows as $row):
                    ?>
                    <tr>
                        <td>
                        ...
                        <td>
                            ...
                            <input type="button" value="更新圖片"  onclick="op('#cover','#cvr','include/update_<?= e($do); ?>.php?id=<?= $row['id'];?>')">
                        </td>
            ...
            <table style="margin-top:40px; width:70%;">
                <tbody>
                    <tr>
                        <td width="200px">
                            <input type="button" onclick="op('#cover','#cvr','include/<?= e($do); ?>.php')" value="新增校園映像資料">
                        </td>
                        <td class="cent">
